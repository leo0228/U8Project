...
public class U8Code {
	 ...
	 * 广告加载完成
	 */
	public static final int CODE_ADS_LOADED = 36;

	/**
	 * 点击广告
	 */
	public static final int CODE_ADS_CLICKED = 37;

	/**
	 * 开始播放广告
	 */
	public static final int CODE_ADS_SHOW = 38;

	/**
	 * 广告播放完成，可以发放奖励
	 */
	public static final int CODE_ADS_COMPLETE = 39;

	/**
	 * 关闭广告
	 */
	public static final int CODE_ADS_CLOSED = 40;

	/**
	 * 广告加载失败
	 */
	public static final int CODE_ADS_FAILED = 41;
}
