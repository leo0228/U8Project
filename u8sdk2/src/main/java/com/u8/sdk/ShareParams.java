...
public class ShareParams {
	...
	public String toString() {
		return "ShareParams [title=" + title + ", titleUrl=" + titleUrl + ", sourceName=" + sourceName + ", sourceUrl="
				+ sourceUrl + ", content=" + content + ", url=" + url + ", imgUrl=" + imgUrl + ", dialogMode="
				+ dialogMode + ", notifyIcon=" + notifyIcon + ", notifyIconText=" + notifyIconText + ", comment="
				+ comment + "]";
	}
